        ...
        >
          <div className="max-w-[370px] w-full mx-auto h-[300px] bg-white rounded-md flex flex-col items-center px-3 ">
            ...
            <div className="flex items-center justify-around gap-3 text-sm text-gray-600">
              <p>on Flexible dates</p> |<p>Trip to Switzerland </p>
            </div>
            <div className="flex items-center justify-around gap-5 my-5  text-sm text-gray-700 font-medium">
              <p>All types of payment accepted </p>
              <p>$2,500 USD + tax</p>|
                               |
